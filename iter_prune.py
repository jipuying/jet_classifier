...
if __name__ == "__main__":
    ...
    if options.batnorm:
        models = {
                  # '32': models.three_layer_model_batnorm_masked(prune_mask_set[0], bn_affine=options.bn_affine, bn_stats=options.bn_stats), #32b
                  ...
                  '6':  models.three_layer_model_bv_tunable(prune_mask_set[3],[38,11,22], 6, bn_affine=options.bn_affine, bn_stats=options.bn_stats) #6b
                  # '4': models.three_layer_model_bv_batnorm_masked(prune_mask_set[4],4, bn_affine=options.bn_affine, bn_stats=options.bn_stats) #4b
                  }
    else:
        models = {
                  # '32': models.three_layer_model_masked(prune_mask_set[0]), #32b
                  # '12': models.three_layer_model_bv_masked(prune_mask_set[1],12), #12b
                  # '8': models.three_layer_model_bv_masked(prune_mask_set[2],8), #8b
                  '6': models.three_layer_model_bv_tunable(prune_mask_set[3], [38,11,22], 6)#6b
